...
::meta-aside-track{title="刷题索引" card}
...
::alert{type="question" title="这题最容易写错在哪"}
...
::alert{type="question" title="这题最容易漏掉什么"}
...
::alert{type="question" title="这题最关键的一步"}
...
::alert{type="question" title="这题最容易卡在哪"}
...
::alert{type="question" title="为什么扩展函数返回 r - l - 1"}
...
::alert{type="question" title="哪些情况可以直接返回原串"}
...
::alert{type="question" title="为什么循环条件是 x > rev"}
...
::alert{type="question" title="为什么三数之和几乎都先排序"}
...
::alert{type="question" title="为什么这题也要排序"}
...
::alert{type="question" title="为什么这题是回溯而不是动态规划"}
...
::alert{type="question" title="KMP 最难的地方通常在哪"}
...
::alert{type="question" title="为什么最后要反转后缀"}
...
::alert{type="question" title="为什么要定义成“以 i 结尾”"}
...
::alert{type="question" title="为什么这题是在叶子节点收集答案"}
...
::alert{type="question" title="为什么去重要写成 i > start"}
...
::alert{type="question" title="这题最值得先剪掉什么"}
