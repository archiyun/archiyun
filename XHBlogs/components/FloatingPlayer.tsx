...
export default function FloatingPlayer() {
  ...
  const { currentSong, isPlaying, isShuffle, togglePlay, nextSong, toggleShuffle, currentLyric, isLoading } = useMusic();
      ...
      >
        ...
        <div className="flex items-center gap-2 ml-1">
          <button
            ...
            className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors cursor-pointer ${isShuffle ? 'bg-indigo-500 text-white' : 'text-slate-500 hover:text-indigo-500'}`}
          >
